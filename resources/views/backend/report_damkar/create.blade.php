                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    @if($checkDateSchedulePicket != null)
                                                        <div class="w-100 text-center border-primary shadow-lg border"><h1>Data Absen Hari Ini Telah di SUBMIT</h1></div>
                                                    @else
                                                    <table
                                                        ...
                                                        @foreach($members as $member)
                                                            <tr class="w-100">
                                                                <th>
                                                                    {{$member->name}}
                                                                    <input name="member[]" type="hidden" value="{{$member->id}}, {{$member->name}}" >
                                                                </th>
                                                                <th>Anggota</th>
                                                                <th><select  name="status_picket[]" class="form-control input-sm" style="width: 100% !important;"
                                                                            data-placeholder="select a status picket"
                                                                            tabindex="4">

                                                                        <option selected="selected"></option>
                                                                        <option class="text-capitalize" value="A, piket hadir">piket
                                                                            hadir
                                                                        </option>
                                                                        <option class="text-capitalize" value="B, cadangan piket">cadangan
                                                                            piket
                                                                        </option>
                                                                        <option class="text-capitalize" value="c, lepas piket">lepas
                                                                            piket
                                                                        </option>
                                                                    </select></th>
