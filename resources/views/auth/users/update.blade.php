                ...
                <div class="panel-body">
                    {!! csrf_field() !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            <input type="text" name="name" class="form-control input-sm" placeholder="@lang('auth.index_name_th')" value="{{ old('name') ?? $data->name }}" tabindex="1">
                            {!! $errors->first('name', '<p class="text-danger">:message</p>') !!}
                        </div>

                         <div class="form-group @if($errors->has('email')) has-error @endif">
                             <label for="email" class="control-label">@lang('auth.form_user_email_label') <span style="color: red">*</span></label>
                             <input type="text" name="email" class="form-control input-sm" placeholder="user@risetproduk.com" value="{{ old('email') ?? $data->email }}" tabindex="3" disabled>
                    ...
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('phone')) has-error @endif">
                            ...
                            <input type="text" name="phone" class="form-control input-sm" placeholder="@lang('auth.form_user_phone_label')" value="{{ old('phone') ?? $data->phone }}" tabindex="1">
