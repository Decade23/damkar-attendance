                                ...
                                <div contentid="logo">
                                  <div contentid="logo">
                                    <div style="text-align: center;">
                                      <img align="bottom" alt="Company Logo" border="0" height="200" src="{{asset('images/super-trader-signal-id.png')}}" style="margin: 0; margin-right: 0px; margin-left: 0px; padding: 0; background: none; border: none; white-space: normal; line-height: normal;" title="Company Logo" width="370" />
                                    </div>
                                  </div>
                                </div>
                              </div>
